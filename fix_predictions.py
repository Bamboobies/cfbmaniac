...
with open("src/predictions-init.js", "r") as f:
    content = f.read()
...
if start_idx != -1 and end_idx != -1:
    ...
    with open("src/predictions-init.js", "w") as f:
        f.write(new_content)
    print("Replaced successfully in predictions-init.js")
else:
    print("Could not find blocks in predictions-init.js")
